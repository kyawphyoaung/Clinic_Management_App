...
const COUNTRY_OPTIONS = [
  ...
  { value: "ID", label: { en: "Indonesia", mm: "အင်ဒိုနီးရှား", zh: "印尼" } },
  ...
  { value: "IN", label: { en: "India", mm: "အိန္ဒိယ", zh: "印度" } },
  { value: "AU", label: { en: "Australia", mm: "ဩစတြေးလျ", zh: "澳洲" } },
  { value: "CA", label: { en: "Canada", mm: "ကနေဒါ", zh: "加拿大" } },
  { value: "GB", label: { en: "United Kingdom", mm: "ယူနိုက်တက်ကင်းဒမ်း", zh: "英國" } },
  { value: "AE", label: { en: "United Arab Emirates", mm: "ယူအေအီး", zh: "阿拉伯聯合大公國" } },
  ...
  // =============================================================
  {
    ...
    fields: [
      ...
      },
      {
        name: "job_title",
        type: "text",
        label: { en: "Job Title", mm: "ရာထူး", zh: "職稱" },
        placeholder: { en: "e.g., Director, Manager, Doctor", mm: "ဥပမာ - ဒါရိုက်တာ၊ မန်နေဂျာ၊ ဆရာဝန်", zh: "例如：總監、經理、醫師" },
        required: true,
      },
      {
      ...
      },
      {
        ...
        type: "text",
        label: { en: "Business Address", mm: "လုပ်ငန်းလိပ်စာ", zh: "公司地址" },
        placeholder: { en: "Full business address", mm: "လုပ်ငန်းလိပ်စာအပြည့်အစုံ", zh: "完整公司地址" },
        required: true,
        colSpan: 2,
      },
      {
        name: "mobile_number",
        type: "tel",
        label: { en: "Mobile Number (including country code)", mm: "မိုဘိုင်းဖုန်းနံပါတ် (နိုင်ငံကုဒ်ပါ)", zh: "手機號碼（含國碼）" },
